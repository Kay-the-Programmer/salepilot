                ...
                <form onSubmit={handleSubmit} className="flex flex-col h-full">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900/50 px-6 py-5 border-t border-slate-200 dark:border-slate-800 flex flex-col-reverse sm:flex-row justify-end gap-3">
                        <button
                            type="button"
                            onClick={onClose}
                            className="w-full sm:w-auto px-6 py-2.5 text-sm font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-all duration-200 transition-colors"
                        >
                            Cancel
                        </button>
                        <button
