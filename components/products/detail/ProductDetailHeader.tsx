...
const ProductDetailHeader: React.FC<ProductDetailHeaderProps> = ({
    ...
    return (
        <header className="px-4 sm:px-6 py-3 border-b border-slate-200 dark:border-white/10 flex items-center justify-between bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-10 w-full animate-in slide-in-from-top-2 duration-300">
            ...
            <div className="flex items-center gap-2">
                {canManage && (
                    <button
                        ...
                        className="px-3 py-2 border border-slate-200 dark:border-white/10 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-sm font-medium flex items-center gap-2 text-slate-700 dark:text-slate-300 transition-colors"
                    >
                ...
                <div className="relative" ref={menuRef}>
                    <button
                        ...
                        className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-white/10 transition-colors"
