        ...
        <div className="pb-20">
            ...
            <section className="max-w-[1400px] mx-auto px-6 py-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
                <div className="lg:col-span-8 bg-slate-900 rounded-3xl overflow-hidden relative min-h-[400px] flex items-center px-12">
                    <div className="relative z-10 max-w-lg">
                        ...
                        <button
                            ...
                            className="px-8 py-4 bg-[#FF7F27] text-white rounded-full font-bold uppercase text-xs tracking-widest hover:bg-[#E66B1F] transition-colors active:scale-95 transition-all duration-300"
                        >
                            Post a Request
                        </button>
                    </div>
                ...
                <div className="lg:col-span-4 flex flex-col gap-6">
                    <div className="flex-1 bg-white border border-slate-100 rounded-3xl p-8 relative overflow-hidden group hover:shadow-xl transition-shadow cursor-pointer active:scale-95 transition-all duration-300" onClick={() => navigate('/marketplace?view=requests')}>
                    ...
                    <div className="flex-1 bg-white border border-slate-100 rounded-3xl p-8 relative overflow-hidden group hover:shadow-xl transition-shadow cursor-pointer active:scale-95 transition-all duration-300" onClick={() => navigate('/marketplace?view=activity')}>
            ...
            <section className="max-w-[1400px] mx-auto px-6 py-12">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex gap-2">
                        <button className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center hover:bg-slate-900 hover:text-white transition-colors active:scale-95 transition-all duration-300">
            ...
            {selectedProduct && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="liquid-glass-card rounded-[2rem] rounded-[40px] max-w-2xl w-full overflow-hidden animate-in zoom-in-95 duration-200">
                        <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                            ...
                            <div className="p-10 relative">
                                <button
                                    ...
                                    className="absolute top-6 right-6 p-2 bg-slate-100 rounded-full hover:bg-slate-200 transition-colors active:scale-95 transition-all duration-300"
                                >
                                ...
                                <button className="w-full py-4 bg-slate-900 text-white rounded-2xl font-bold uppercase tracking-widest text-xs hover:bg-indigo-600 transition-colors shadow-lg shadow-indigo-200/50 active:scale-95 transition-all duration-300">
                                    Add to Cart
                                </button>
                            </div>
                        </div>
