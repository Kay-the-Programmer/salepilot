            ...
            {activeTab === 'sent' && (
                <div className="space-y-4">
                    {sentOffers.length > 0 ? sentOffers.map(offer => (
                        <div key={offer.id} className="bg-white p-6 rounded-2xl border border-slate-100 flex items-center justify-between hover:shadow-lg transition-all">
                ...
                <div className="space-y-4">
                    {receivedRequests.length > 0 ? (
                        ...
                        <div className="text-center py-12 bg-white rounded-3xl border border-dashed border-slate-200">
                            ...
                            <button className="mt-4 px-6 py-2 bg-indigo-50 text-indigo-600 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-indigo-100 transition-colors">
                                Create New Request
                            </button>
                        </div>
                    )}
