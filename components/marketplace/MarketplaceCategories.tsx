                        ...
                        <div key={cat.id} className="group cursor-pointer">
                            <div className="relative overflow-hidden rounded-lg aspect-[3/4] mb-4">
                                ...
                                <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2">
                                    <span className="bg-white px-6 py-2 rounded-full text-sm font-medium shadow-sm whitespace-nowrap">
                                        {cat.name}
                                    </span>
                                </div>
                            </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="relative rounded-lg overflow-hidden h-[400px]">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-t from-black/40 to-transparent">
                            ...
                            <button className="bg-white text-black px-6 py-2 rounded-full self-start font-medium text-sm hover:bg-gray-100">Shop now</button>
                        </div>
                    </div>
                    <div className="relative rounded-lg overflow-hidden h-[400px]">
